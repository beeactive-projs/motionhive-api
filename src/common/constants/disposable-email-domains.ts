 ...
 * (MIT-licensed). This file mirrors `disposable_email_blocklist.conf` from that
 * repo.
 *
 * To refresh:
 ...
 *     | node scripts/build-disposable-domains.js > src/common/constants/disposable-email-domains.ts
 *
 * (No build script exists today — regenerate by hand with awk or a one-liner
 * and commit. See `scripts/` if one is added later.)
 *
 * Domains are compared lowercase against the email's domain part. Keep this
 * set frozen to prevent accidental runtime mutation.
 */
